export default {
  ...
  wishlist: {
    ...
    empty: {
      title: "Wishlist vide",
      description: "Gardez une trace des sets qui vous font envie et de votre budget.",
      cta: "Ajouter un set",
    },
    form: {
      title: "Ajouter à la wishlist",
      editTitle: "Modifier l'item",
      priority: "Priorité",
      targetPrice: "Budget",
      url: "Lien",
      urlPlaceholder: "https://www.lego.com/...",
      notes: "Notes",
      notesPlaceholder: "Ex: attendre promo, cadeau pour...",
      submit: "Ajouter",
      update: "Enregistrer",
    },
    purchaseModal: {
      title: "Marquer comme acheté",
      subtitle: "Ce set sera ajouté à votre collection et retiré de la wishlist.",
      purchasePrice: "Prix d'achat",
      purchaseDate: "Date d'achat",
      condition: "État",
      notes: "Notes",
      submit: "Confirmer l'achat",
    },
    deleteDialog: {
    ...
    errors: {
      loadingFailed: "Impossible de charger la wishlist.",
      createFailed: "Impossible d'ajouter à la wishlist.",
      updateFailed: "Impossible de modifier l'item.",
      deleteFailed: "Impossible de retirer de la wishlist.",
      alreadyInWishlist: "Ce set est déjà dans votre wishlist.",
      purchaseFailed: "Impossible de marquer comme acheté.",
    },
  },
  charts: {
    barChart: {
